...
@interface ClassCataloguesViewController()
{
...
@implementation ClassCataloguesViewController

#pragma mark Private
-(void)loadRecmdList
{
    BookEntryBase* bookData= [RJBookData sharedRJBookData];
    if (bookData) {
...
{
    [super loadView];
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(datasetChanged:) name:kDatasetChanged object:nil];
